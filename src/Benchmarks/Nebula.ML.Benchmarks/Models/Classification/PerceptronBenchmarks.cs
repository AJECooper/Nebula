// <copyright file="PerceptronBenchmarks.cs" company="Nebula">
...
namespace Nebula.ML.Benchmarks.Models.Classification
{
    ...
    [MemoryDiagnoser]
    public class PerceptronBenchmarks
    {
        ...
        [Benchmark(Description = "Trains the model to predict for new data points over 100 epochs")]
        public void Benchmark_Fit()
        {
            var model = new Perceptron(null, 100);
